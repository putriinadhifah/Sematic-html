  ...
  return (
    <div className="px-5 max-[400px]:px-3 mt-12 mb-24">
      <div className="flex flex-col gap-6 justify-center items-center w-1/2 mx-auto max-sm:w-3/4 max-sm:gap-5">
        <p className="text-xl max-sm:text-lg">Menunjukkan { showingProducts } Dari { totalProducts }</p>
        <Button
          text="View More"
          mode="white"
          onClick={() => {
...
// fitur pencarian (search) + pagination di halaman shop
